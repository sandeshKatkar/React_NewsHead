...
export default class News extends Component{
    ...
    constructor(){
     ...
     async componentDidMount(props){
        ...
        let url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=3807b3b4bdba43aa8b1f6fc9e0f30932&page=1&pageSize=${this.props.pagesize}`;
